      ...
      <div className='form-box'>
        ...
        <motion.div variants={container} animate="visible" initial="hidden" className='form-input'>
          ...
          <motion.div variants={container} className='select-container justify-items-stretch'>
            ...
            <motion.button variants={item} whileHover={{scale:1.1}} whileTap={{scale:0.9}} onClick={clickChange} value="Bitterness" name="stressor" className={` user-select col-span-3 row-span-2 focus:bg-blue-200 `}> Bitterness </motion.button>
